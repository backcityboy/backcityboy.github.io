document.addEventListener("DOMContentLoaded", () => {
    ...
    const products = [
        { name: "Carne com queijo", cat: "pastel", price: 12.00, desc: "Carne temperada, queijo derretido e massa crocante.", img: "assets/pastel-carne-real.jpg" },
        { name: "Frango com catupiry", cat: "pastel", price: 13.00, desc: "Frango cremoso com catupiry e aquele toque especial.", img: "assets/pastel-frango-real.jpg" },
        { name: "Pizza", cat: "pastel", price: 12.50, desc: "Presunto, queijo, tomate e orégano.", img: "assets/pastel-pizza-real.jpg" },
        { name: "Coxinha", cat: "salgado", price: 7.00, desc: "Massa douradinha e recheio cremoso de frango.", img: "assets/coxinha-real.jpg" },
        { name: "Bolinha de queijo", cat: "salgado", price: 6.50, desc: "Crocante por fora e muito queijo por dentro.", img: "assets/bolinha-queijo-real.jpg" },
        { name: "Guaraná lata", cat: "bebida", price: 6.00, desc: "Refrescante e geladinho.", img: "assets/guarana-real.jpg" }
    ];
